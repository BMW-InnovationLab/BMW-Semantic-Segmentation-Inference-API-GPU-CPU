...
from .resnetv1b import resnet50_v1s, resnet101_v1s, resnet152_v1s,resnet50_v1b,resnet101_v1b
...
def get_segmentation_model(model,pretrainedbase='none',classes=1000, **kwargs):
    ...
    return models[model](pretrainedbase=pretrainedbase,classes=classes,**kwargs)
...
class SegBaseModel(HybridBlock):
    ...
    def __init__(self, nclass, aux, backbone='resnet50', height=None, width=None,
                 base_size=520, crop_size=480,pretrainedbase='none',classes=1000,pretrained_base=True, **kwargs):
        ...
        with self.name_scope():
            ...
            elif backbone == 'resnet50v1b':
                pretrained = resnet50_v1b(pretrained=pretrained_base,pretrainedbase=pretrainedbase ,classes=classes,dilated=True, **kwargs)
            elif backbone == 'resnet101v1b':
                pretrained = resnet101_v1b(pretrained=pretrained_base,pretrainedbase=pretrainedbase, classes=classes,dilated=True, **kwargs)
            elif backbone == 'resnet152':
                pretrained = resnet152_v1s(pretrained=pretrained_base, dilated=True, **kwargs)
            elif backbone == 'resnet50':
                pretrained = resnet50_v1s(pretrained=pretrained_base,pretrainedbase=pretrainedbase ,classes=classes,dilated=True, **kwargs)
            elif backbone == 'resnet101':
                pretrained = resnet101_v1s(pretrained=pretrained_base,pretrainedbase=pretrainedbase ,classes=classes,dilated=True, **kwargs)
